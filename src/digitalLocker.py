...
def startServer() :
    esp.osdebug(None)
    gc.collect()
    ssid = 'NameOfNetworkTP' # coloque o nome da rede
    password = '0123456789' # senha
    ...
    def web_page():
        ...
        <p>Locker state: <strong>""" + locker_state  + """</strong></p><p><a href="/?locker=on"><button class="button">ON</button></a></p>
